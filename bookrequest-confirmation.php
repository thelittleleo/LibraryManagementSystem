                ...
                <div class="panel-body">
                    <form role="form" method="post" action="confirm.php">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="studentid" value="<?php echo $student_id;?>" required />
                            <br>
                            <label>Book</label>
                            <?php
                            ...
                            if($query->rowCount() > 0)
                            {
                                ...
                                {               ?>
                                    ...
                                    <br>
                                    <input class="form-control" type="text" name="bookid" disabled="disabled" value="<?php echo htmlentities($result->id);?>" />
                                    <img src="admin/images/<?php echo htmlentities($result->image)?>" alt="bookimage" width="100dpx" height="140dpx" align="center">
                                
                        </div>

                        <button type="submit" id="submit" name="confirm" class="btn btn-info">Add </button>
