...
{               ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><img src="images/<?php echo htmlentities($result->image);?>" width="60dpx" height="80dpx" alt="<?php echo htmlentities($result->BookName);?>"></td>
                                            <td class="center">
                                                <?php
                                                if(($result->Status)==1)
                                                { $check=1;
                                          ...
                                          <a href="manage-books.php?del=<?php echo htmlentities($result->bookid);?>"
                                             onclick="return confirm('Are you sure you want to delete?');" >
                                                ...
                                                <?php if($check == 1){
                                                    echo "  <a href=\"issue-book.php\"><button class=\"btn btn-success\"><i class=\"fa fa-edit \"></i> Issue</button>";
                                                } ?>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>
