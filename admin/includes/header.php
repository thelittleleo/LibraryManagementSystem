<div class="navbar navbar-inverse set-radius-zero" >
 ...
 <li>
                           ...
                           <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="request-list.php">Issue New Book</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-issued-books.php">Manage Issued Books</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">Request List<i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="request-list.php">Book Lend Request</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="buy-request-list.php">Book Buy Request</a></li>
                                </ul>
                            </li>
                             <li><a href="reg-students.php">Reg Students</a></li>
                            <!-- <li><a href="request-list.php">Books Request</a></li>
                            <li><a href="request-list.php">Buying Request</a></li> -->
